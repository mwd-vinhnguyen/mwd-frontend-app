...
`mwd-fronted-app` does not use "^", "~", etc., and these should be removed from `package.json`, if present. See [#598](https://github.com/mwd-fronted-app/mwd-fronted-app/issues/598) for more details.
...
```js
import TestPage from 'features/TestPage/Loadable';
...
```bash
   ...
   /home/travis/build/gihrig/mwd-fronted-app/node_modules/react-router-scroll/lib'
...
- `history` Incompatible
  ...
  mwd-fronted-app@3.4.0 /Users/glen/Documents/JavaScript/Research/react-bp
...
- Error: (some OS X installations only, not version specific)
  ...
  Referenced from: ~/mwd-fronted-app/node_modules/mozjpeg/vendor/cjpeg
  Reason: image not found

  **_image-webpack-loader 2.0.0 → 3.0.0 <--- rolled back_**
  see: https://github.com/mxstbr/mwd-fronted-app/pull/1322#issuecomment-266264527 and #1335
